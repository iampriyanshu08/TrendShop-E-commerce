...
const Contact = () => {
  ...
  const handleSubmitContact = (e) => {
    ...
    if (!usercontact.username || !usercontact.email || !usercontact.msg) {
      ...
      addDoc(collection(db, "userContact"), {
        user: usercontact.username,
        email: usercontact.email,
        message: usercontact.msg,
      })
        .then(() => {
          toast.success(`${usercontact.username} your form submitted successfully !`);
...
<div className="relative">
      ...
      <section className="text-gray-600 body-font relative mt-0">
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                  ></textarea>
                </div>
              </div>
              <div className="p-2 w-full">
